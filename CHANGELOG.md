...
- **bash**: Add zoxide init and Homebrew login shell setup

### Fixed

- **git,shell**: Remove hardcoded paths and cross-platform issues

## [1.0.7] - 2026-05-12

### Documentation

- Add CLAUDE.md and update copilot instructions

## [1.0.6] - 2026-05-12

### Fixed

- **editorconfig**: Add extensionless shell dotfiles and git config rules
